# -*- coding: utf-8 -*-
"""FewShot_GatedConvVAE_SylvesterVAE_WGANResnet_Noise - Pytorch.ipynb
...
class FIGR:
    ...
    def initialize_vae(self):
        ...
        self.d = ResNetDiscriminator(self.channels, self.height, self.length)
        self.meta_d = ResNetDiscriminator(self.channels, self.height, self.length).to(device)
    ...
    def inner_loop(self, real_batch):
        ...
        recon_loss, bce_loss, kl_loss = self.vae_loss_fn(recon_batch, real_batch, mu, logvar, z0, zk, ldj, beta=beta)
