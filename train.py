...
options:
    ...
    --height=h                  Hieght of image [default: 32]
    --length=l                  Length of image [default: 32]
    --dataset=ds                Dataset name (Mnist, Oniglot, FIGR8) [default: FIGR8]
...
def calc_gradient_penalty(disciminator, real_batch, fake_batch):
    ...
    disc_interpolates = disciminator(interpolates)
...
class FIGR:
    ...
    def initialize_gan(self):
        ...
        self.g = eval(self.neural_network + 'Generator(self.z_shape, self.env.channels, self.env.height, self.length)')
    ...
    def validation_run(self):
        ...
        with torch.no_grad():
            ...
            self.writer.add_scalar('Validation_geneartor_loss', generator_total_loss, self.eps)
